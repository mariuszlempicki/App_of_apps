def frontendImage="mariuszlempicki/panda_frontend"
def backendImage="mariuszlempicki/panda_backend"
...
pipeline {
    ...
    stages {
        ...
        stage('Run terraform') {
            steps {
                dir('Terraform') {                
                    git branch: 'main', url: 'https://github.com/mariuszlempicki/Terraform.git'
